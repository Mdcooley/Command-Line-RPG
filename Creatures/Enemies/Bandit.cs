...
namespace RPG_Project
{
    ...
    {
        /// <summary>
        /// Constructor for the Bandit class. Sets the base stats & initiative.
        /// Sets the name to "Bandit" + number (Bandit1, Bandit2, etc..) based off of 
        /// the objects order in combat
        /// </summary>
        /// <param name="number"></param>
        public Bandit(int number, int level)
        {
