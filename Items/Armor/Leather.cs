...
namespace RPG_Project
{
    class Leather : IEquipment
    {
        ...
        /// <summary>
        /// Constructor for the leather armor class, sets the name, type, class, and stat modifiers
        /// </summary>
        public Leather()
        {
            Type = "Armor";
            ...
            StatBlock = new Dictionary<string, int> { { "Dex", 2 }, { "EV", 2 } };
